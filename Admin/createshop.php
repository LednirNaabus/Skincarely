...
<div class="container" style="font-family: Poppins;">
    <form action="shop_creation.php" method="post" enctype="multipart/form-data">
        ...
        <input type="checkbox" id="payment" name="payment[]" value="E-wallet"/>E-wallet
        <input type="checkbox" id="payment" name="payment[]" value="Credit Card"/>Credit Card
        <input type="checkbox" id="payment" name="payment[]" value="Cash on Delivery"/>Cash on Delivery 
        </div>
