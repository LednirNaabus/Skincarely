...
$result = mysqli_query($link, "SELECT * FROM shops WHERE shop_id = 2");
$shopInfo = mysqli_fetch_row($result);
?>  
    <div class="sidebar">
        <div class="card w-100">
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="image" style="text-align:center">
                        <?php if ($shopInfo[3] == NULL) {
                            echo '<img src="dist/img/user.png" class="img-circle" alt="User Image">';
                        } else {
                            echo '<img src="data:image;base64,', base64_encode($shopInfo[3]), 'alt="" class="img-circle">';
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="row justify-content-center" style="padding-top:30px">
                <h4><b><?php echo $shopInfo[2]; //Shop name ?></b>
                    <h4>
            </div>
            <div class="row justify-content-center">
            ...
            <div class="row" style="padding-left: 15px">
                <p style="font-size: 15px"><?php echo $shopInfo[2] //Shop name ?></p>
            </div>
            <div class="row" style="padding-left:15px">
